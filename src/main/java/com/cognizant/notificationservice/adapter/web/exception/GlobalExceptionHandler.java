package com.cognizant.notificationservice.adapter.web.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePreferenceNotFound(NotificationPreferenceNotFoundException ex) {
        log.error("Notification preference not found: {}", ex.getMessage());
        ErrorResponse error = new ErrorResponse(
                HttpStatus.NOT_FOUND.value(),
                ex.getMessage(),
                LocalDateTime.now()
